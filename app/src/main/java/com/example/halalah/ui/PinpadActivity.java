...
*/
        ...
        mTestCardNo = findViewById(R.id.card_num);
        mTestAmount = findViewById(R.id.trad_amount);
        mPinTips = findViewById(R.id.input_amount_tip);

        mPin = findViewById(R.id.pin_num);
