...
import com.example.halalah.connect.SocketHandler;
...
//        mSocketProcessTask.execute(mSendPacket)
        ...
        SocketHandler socketHandler = SocketHandler.getInstance(new CommunicationInfo(this));
        socketHandler.sendReceive(mProcType, mSendPacket).subscribe(new Observer<Boolean>() {
            @Override
