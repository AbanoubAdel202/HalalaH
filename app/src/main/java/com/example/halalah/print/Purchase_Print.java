...
*/
        ...
        mPrintObjs.add(getPrintItemObjs(PosApplication.getApp().oGPosTransaction.card_scheme.m_sCard_Scheme_Name_English,PrinterConstant.FontSize.NORMAL,true,PrintItemObj.ALIGN.LEFT));
