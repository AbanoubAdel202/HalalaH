...
public class MainActivity extends AppCompatActivity {
    ...
    private void testTMSManager() {
        SAMA_TMS sama_tms = new SAMA_TMS(getApplicationContext());

        // TODO Testing card scheme with repeated segments
