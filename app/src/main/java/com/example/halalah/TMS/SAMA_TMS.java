...
//                                        String spk=POS_MAIN.FormatCAKeys(public_keys);
                            ...
                            case DT_Device_Specific:
                                for (int i = 1; i < segments.length; i++) {
                                    ...
                                    {   int index=3;
                                        int offset=2;
                                        device_specific.mada_CTLS_Limits.m_sCard_Scheme_ID= dspec_seg1_elements[0].substring(index,index+offset);   //length 2//The value configured for the mada scheme (‘P1’) shall apply to all card schemes
                                        index=index+offset;
                                        offset=5;
                                        device_specific.mada_CTLS_Limits. m_sTerminal_Contactless_Transaction_Limit= dspec_seg1_elements[0].substring(index, index+offset);  //length 5
                                        index=index+offset;
                                        offset=5;
                                        device_specific.mada_CTLS_Limits. m_sTerminal_CVM_Required_Limit= dspec_seg1_elements[0].substring(index, index+offset);             //length 5
                                        index=index+offset;
                                        offset=5;
                                        device_specific.mada_CTLS_Limits. m_sTerminal_Contactless_Floor_Limit= dspec_seg1_elements[0].substring(index, index+offset);        //length 5
                                        index=index+offset;
                                        offset=2;
                                        device_specific.Visa_CTLS_Limits.m_sCard_Scheme_ID= dspec_seg1_elements[0].substring(index, index+offset);                          //length 2
                                        index=index+offset;
                                        offset=5;
                                        device_specific.Visa_CTLS_Limits.m_sTerminal_Contactless_Transaction_Limit= dspec_seg1_elements[0].substring(index, index+offset); //length 5      //zeros as per spec Version 6.0.9
                                        index=index+offset;
                                        offset=5;
                                        device_specific.Visa_CTLS_Limits.m_sTerminal_CVM_Required_Limit= dspec_seg1_elements[0].substring(index, index+offset);            //length 5              //zeros as per spec Version 6.0.9
                                        index=index+offset;
                                        offset=5;
                                        device_specific.Visa_CTLS_Limits.m_sTerminal_Contactless_Floor_Limit= dspec_seg1_elements[0].substring(index, index+offset);       //length 5           //zeros as per spec Version 6.0.9
                                        index=index+offset;
                                        offset=2;
                                        device_specific.Mastercard_CTLS_Limits.m_sCard_Scheme_ID= dspec_seg1_elements[0].substring(index, index+offset);                          //length 2
                                        index=index+offset;
                                        offset=5;
                                        device_specific.Mastercard_CTLS_Limits. m_sTerminal_Contactless_Transaction_Limit= dspec_seg1_elements[0].substring(index, index+offset); //length 5      //zeros as per spec Version 6.0.9
                                        index=index+offset;
                                        offset=5;
                                        device_specific.Mastercard_CTLS_Limits. m_sTerminal_CVM_Required_Limit= dspec_seg1_elements[0].substring(index, index+offset);            //length 5        //zeros as per spec Version 6.0.9
                                        index=index+offset;
                                        offset=5;
                                        device_specific.Mastercard_CTLS_Limits. m_sTerminal_Contactless_Floor_Limit= dspec_seg1_elements[0].substring(index, index+offset);       //length 5        //zeros as per spec Version 6.0.9
                                        index=index+offset;
                                        offset=3;
