...
public class SAMA_TMS implements Serializable {
    ...
    public void Get_Sama_param(String DE72_Buffer) {
...
//
    ...
    private Connection setConnectionsParameters(String priority, String connection_type, String[] conn_seg1_elements) {
        switch (connection_type) {
            case DIAL_UP:
                ...
                dialup.Phone_Number = conn_seg1_elements[2];
                dialup.Dial_Attempts_to_Phone = conn_seg1_elements[3];
                dialup.Connect__Time_for_Phone = conn_seg1_elements[4];
                dialup.Baud_Rate_Default2 = conn_seg1_elements[5];
                dialup.Parity_Bit = conn_seg1_elements[6];
                dialup.Data_Bit = conn_seg1_elements[7];
                dialup.Stop_Bit = conn_seg1_elements[8];
                dialup.Response_timeout = conn_seg1_elements[9];
                return dialup;
            ...
            case TCP_IP:
                ...
                tcp_ip.Network_IP_Address = conn_seg1_elements[2];
                tcp_ip.Network_TCP_Support = conn_seg1_elements[3];
                tcp_ip.Count_Access_Retries = conn_seg1_elements[4];
                tcp_ip.Response_Time_Out = conn_seg1_elements[5];
                tcp_ip.SSL_Certificate_File = conn_seg1_elements[6];
                return tcp_ip;
            ...
            case GPRS:
                ...
                gprs.GPRS_dial_Number = conn_seg1_elements[2];
                gprs.GPRS_access_point_name = conn_seg1_elements[3];
                gprs.Connect__Time_for_GPRS_phone = conn_seg1_elements[4];
                gprs.Network_IP_address = conn_seg1_elements[5];
                gprs.Network_TCP_port = conn_seg1_elements[6];
                gprs.Dial_attempts_to_network = conn_seg1_elements[7];
                gprs.Response_time_out = conn_seg1_elements[8];
                gprs.SSL_Certificate_file = conn_seg1_elements[9];
                return gprs;
            ...
            case WIFI:
                ...
                wifi.Network_IP_Address = conn_seg1_elements[2];
                wifi.Network_TCP_Support = conn_seg1_elements[3];
                wifi.Count_Access_Retries = conn_seg1_elements[4];
                wifi.Response_Time_Out = conn_seg1_elements[5];
                wifi.SSL_Certificate_File = conn_seg1_elements[6];
                return wifi;
            ...
            case GSM:
                ...
                gsm.Phone_Number = conn_seg1_elements[1];
                gsm.Dial_Attempts_to_Phone = conn_seg1_elements[2];
                gsm.Connect__Time_for_Phone = conn_seg1_elements[3];
                gsm.Baud_Rate_Default2 = conn_seg1_elements[4];
                gsm.Parity_Bit = conn_seg1_elements[5];
                gsm.Data_Bit = conn_seg1_elements[6];
                gsm.Stop_Bit = conn_seg1_elements[7];
                gsm.Response_timeout = conn_seg1_elements[8];
                return gsm;
        }
